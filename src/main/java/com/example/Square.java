...
public class Square extends JComponent {
    ...
    // NOTE: no second constructor here
    ...
    // Note*: if you want to mess with the color scheme of the board edit the g.setColor method calls below to use the colors of your choice.
